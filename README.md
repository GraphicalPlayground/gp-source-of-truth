...
If you discover a security vulnerability within `{{GP_REPO_NAME}}`, please do not report
...
`{{GP_REPO_NAME}}` is open-source software. Please see the [LICENSE.md](./LICENSE.md) file in the root
directory for full terms regarding modification, distribution, and use in your own projects.

### Donations

If you find `{{GP_REPO_NAME}}` helpful for your learning, academic research, or game development journey,
...
If you have any questions, suggestions, or want to share your projects built with `{{GP_REPO_NAME}}`, we
